...
# Database: zcurd
# Generation Time: 2016-02-21 15:27:43 +0000
# ************************************************************
...
CREATE TABLE `sys_menu_datarule` (
  ...
  `sql_value` varchar(200) DEFAULT NULL COMMENT 'sql条件值',
...
VALUES
	(148,1,3,'2016-02-20 01:36:05'),
	(149,1,2,'2016-02-20 01:36:05'),
	(150,1,5,'2016-02-20 01:36:05'),
	(151,1,1,'2016-02-20 01:36:05');
...
VALUES
	...
	(374,1,20,'2016-02-20 01:36:05'),
	(375,1,2,'2016-02-20 01:36:05'),
	(376,1,19,'2016-02-20 01:36:05'),
	(377,1,4,'2016-02-20 01:36:05'),
	(378,1,18,'2016-02-20 01:36:05'),
	(379,1,6,'2016-02-20 01:36:05'),
	(380,1,12,'2016-02-20 01:36:05');
...
VALUES
	...
	(185,130,'info','备注',120,'varchar','easyui-textbox',1,1,1,0,0,1,'',7,1,'2016-01-08 16:25:53'),
	(186,131,'id','id',120,'int','easyui-textbox',1,1,1,1,0,1,'',0,1,'2016-01-08 16:31:45'),
	(187,131,'user_name','用户名',120,'varchar','easyui-textbox',1,1,1,1,1,1,'',0,1,'2016-01-08 16:31:45'),
	(188,131,'password','密码',120,'varchar','easyui-textbox',1,1,1,1,0,1,'',0,1,'2016-01-08 16:31:45'),
	(189,131,'create_time','创建时间',120,'timestamp','easyui-textbox',1,1,0,0,1,1,'',0,2,'2016-01-08 16:31:45'),
	...
	(542,150,'menu_id','所属菜单',120,'int','easyui-numberspinner',1,1,1,1,1,1,'',0,1,'2016-02-15 11:35:56'),
	(543,150,'btn_name','按钮名称',120,'varchar','easyui-textbox',1,1,1,1,0,1,'',0,1,'2016-02-15 11:35:56'),
	(544,150,'class_name','页面class名称',120,'varchar','easyui-textbox',1,1,1,1,0,1,'',0,1,'2016-02-15 11:35:56'),
	(545,150,'method_name','后台method名称',120,'varchar','easyui-textbox',1,1,1,1,0,1,'',0,1,'2016-02-15 11:35:56'),
	(546,150,'create_time','创建时间',120,'timestamp','easyui-datebox',0,1,0,1,0,0,'',0,1,'2016-02-15 11:35:56'),
...
# Replace placeholder table for v_blog with correct view syntax
# ------------------------------------------------------------

DROP TABLE `v_blog`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`127.0.0.1` SQL SECURITY DEFINER VIEW `v_blog`
AS SELECT
   `blog`.`id` AS `id`,
   `blog`.`title` AS `title`,
