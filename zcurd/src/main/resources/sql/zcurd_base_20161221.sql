...
# Database: zcurd_base
# Generation Time: 2016-12-21 15:15:46 +0000
# ************************************************************
...
CREATE TABLE `common_file` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8 COMMENT='文件管理';
...
) ENGINE=InnoDB AUTO_INCREMENT=39 DEFAULT CHARSET=utf8 COMMENT='菜单按钮';
...
CREATE TABLE `sys_oplog` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=237 DEFAULT CHARSET=utf8 COMMENT='系统操作日志';
...
CREATE TABLE `sys_role` (
  ...
  `create_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='角色管理';
...
CREATE TABLE `sys_role_datarule` (
  ...
  `create_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=47 DEFAULT CHARSET=utf8 COMMENT='角色数据规则';
...
CREATE TABLE `sys_role_menu` (
  ...
  `create_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=582 DEFAULT CHARSET=utf8 COMMENT='角色菜单';
...
CREATE TABLE `sys_user` (
  ...
  `create_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='用户管理';
...
VALUES
	(1,'admin','12345678',NULL,'2016-01-08 15:33:05'),
	(2,'zcurd','123456','2,1','2016-10-29 16:59:44'),
	(3,'readonly','123456','4','2016-10-16 14:22:46'),
	(11,'zhong','123456','2','2016-02-21 01:19:47');
...
CREATE TABLE `zcurd_field` (
  ...
  `create_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=10038 DEFAULT CHARSET=utf8 COMMENT='在线表单字段';
...
CREATE TABLE `zcurd_head` (
  ...
  `create_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=23 DEFAULT CHARSET=utf8 COMMENT='在线表单';
...
VALUES
	...
	(8,'sys_role','角色管理','id',1,1,'400x300','zcurd_base','2016-02-12 01:58:39'),
	(18,'images','图片管理','id',1,1,'600x400','zcurd_busi','2016-12-20 00:17:53'),
	(12,'sys_user','用户管理','id',1,1,'400x300','zcurd_base','2016-01-07 21:31:45'),
	(15,'customer','客户管理','cid',1,1,'800x600','zcurd_busi','2016-09-18 17:31:32'),
	(16,'stock_history_log','股票历史数据','id',1,1,'700x500','zcurd_busi','2016-09-18 17:31:55'),
	(17,'claw_book_url','小说管理','id',1,1,'600x400','zcurd_busi','2016-09-18 17:40:23'),
	(20,'stock_history_log','股票历史数据','id',1,1,'700x500','zcurd_busi','2016-12-21 23:07:45'),
	(21,'claw_book_url','小说链接','id',1,1,'600x400','zcurd_busi','2016-12-21 23:09:46'),
	(22,'images','图片管理','id',1,1,'600x400','zcurd_busi','2016-12-21 23:12:51');
...
CREATE TABLE `zcurd_head_js` (
  ...
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='表单扩展js';
