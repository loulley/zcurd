...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='菜单按钮';

-- ----------------------------
-- Records of sys_menu_btn
-- ----------------------------
INSERT INTO `sys_menu_btn` VALUES ('1', '12', '增加', 'addBtn', 'add,addPage', '2016-09-27 00:14:44');
...
CREATE TABLE `sys_role_menu` (
  ...
  `create_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=449 DEFAULT CHARSET=utf8 COMMENT='角色菜单';
...
INSERT INTO `sys_role_menu` VALUES ('446', '3', '12', '2016-09-27 00:27:21');
INSERT INTO `sys_role_menu` VALUES ('447', '3', '10', '2016-09-27 00:27:21');
INSERT INTO `sys_role_menu` VALUES ('448', '3', '11', '2016-09-27 00:27:21');
...
CREATE TABLE `zcurd_field` (
  ...
  `create_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=10001 DEFAULT CHARSET=utf8 COMMENT='在线表单字段';
...
CREATE TABLE `zcurd_head` (
  ...
  `create_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 COMMENT='在线表单';
