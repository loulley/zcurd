...
# Database: zcurd
# Generation Time: 2016-02-16 06:53:35 +0000
# ************************************************************
...
INSERT INTO `demo_users` (`id`, `status`, `login_id`, `login_pwd`, `nickname`, `reg_time`, `info`)
VALUES
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='dynamic_table';

LOCK TABLES `dynamic_table` WRITE;
/*!40000 ALTER TABLE `dynamic_table` DISABLE KEYS */;

INSERT INTO `dynamic_table` (`id`, `field`, `field_value`, `cid`)
VALUES
	(5,'source','0','1'),
	(6,'name','','1'),
...
CREATE TABLE `riskgrade` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='评级等级管理';

LOCK TABLES `riskgrade` WRITE;
/*!40000 ALTER TABLE `riskgrade` DISABLE KEYS */;

INSERT INTO `riskgrade` (`id`, `name`, `createuser`, `createtime`, `lastupateuser`, `lastupdatetime`, `type`, `source`, `level`, `startrange`, `endrange`)
VALUES
...
# Dump of table riskgradedetail
# ------------------------------------------------------------

DROP TABLE IF EXISTS `riskgradedetail`;

CREATE TABLE `riskgradedetail` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id',
  ...
  `createtime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='评级等级管理';

LOCK TABLES `riskgradedetail` WRITE;
/*!40000 ALTER TABLE `riskgradedetail` DISABLE KEYS */;

INSERT INTO `riskgradedetail` (`id`, `riskgradeid`, `level`, `comment`, `startrange`, `endrange`, `createtime`)
VALUES
...
VALUES
	...
	(17,'客户管理','/zcurd/133/listPage',5,NULL,4,'2016-01-09 10:08:06'),
...
VALUES
	(1,1,1,'2016-02-09 19:05:20'),
	(2,1,2,'2016-02-09 19:05:24'),
	(3,1,3,'2016-02-09 19:05:29'),
	(4,1,4,'2016-02-09 20:12:10'),
	(5,1,5,'2016-02-09 20:12:17');
...
VALUES
	(1,1,1,'2016-02-04 22:05:45'),
	(2,1,2,'2016-02-04 22:05:45'),
	(3,1,3,'2016-02-04 22:13:53'),
	(4,1,4,'2016-02-05 19:22:09'),
	(5,1,5,'2016-02-05 19:22:15'),
	(6,1,6,'2016-02-05 19:22:23'),
	(7,1,12,'2016-02-09 21:59:59');
...
INSERT INTO `sys_user` (`id`, `user_name`, `password`, `create_time`)
VALUES
...
CREATE TABLE `zcurd_field` (
  ...
  `create_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='在线表单字段';

LOCK TABLES `zcurd_field` WRITE;
/*!40000 ALTER TABLE `zcurd_field` DISABLE KEYS */;

INSERT INTO `zcurd_field` (`id`, `head_id`, `field_name`, `column_name`, `column_length`, `data_type`, `input_type`, `is_show_list`, `is_allow_add`, `is_allow_update`, `is_search`, `is_allow_null`, `dict_sql`, `order_num`, `search_type`, `create_time`)
VALUES
...
CREATE TABLE `zcurd_head` (
  ...
  `create_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='在线表单';

LOCK TABLES `zcurd_head` WRITE;
/*!40000 ALTER TABLE `zcurd_head` DISABLE KEYS */;

INSERT INTO `zcurd_head` (`id`, `table_name`, `form_name`, `id_field`, `is_auto`, `form_type`, `dialog_size`, `create_time`)
VALUES
...
CREATE TABLE `zcurd_head_btn` (
  ...
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='表单按钮';
...
VALUES
	...
	(3,148,'权限设置',2,1,'function(){}','2016-02-12 22:23:10');
...
CREATE TABLE `zcurd_head_js` (
  ...
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='表单扩展js';
...
VALUES
	...
	(2,150,'list','window.parent.getDgSelections = function() {\n    return datagrid.datagrid(\"getSelections\");\n}','2016-02-15 12:13:14');
