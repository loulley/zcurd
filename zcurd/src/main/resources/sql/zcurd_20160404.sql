...
# Database: zcurd
# Generation Time: 2016-04-04 14:41:41 +0000
# ************************************************************
...
VALUES
	...
	(186,0,0,'马大哈1','450521198911177','12134564845',23,'重庆',281499,'龙水湖国际旅游度假区',0,1,0,0,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,0,0,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,'测试',NULL,NULL,0,0,0,0,NULL,NULL,0,NULL,0,0,0,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,2,'2016-01-06 00:00:00','admin',0,0,0,NULL,116,'1852',NULL,NULL,0,NULL,NULL,NULL,0,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,0,NULL,0,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,0),
...
VALUES
	(2,0,'test21','000000','雪人骑士','2014-12-30 00:55:49',''),
	...
	(27,1,'test27','000000','德邦总管','2014-12-30 00:55:49',''),
	...
	(52,1,'原梓菲工1','sadfa','sadf','2016-02-20 02:17:16','asdfasfasfasf樭奔在夺'),
	(53,1,'adafasdfa','dasfadsf','','2016-02-20 02:31:15',''),
	(54,1,'dsafasdf11','sadf','','2016-02-20 02:31:52',''),
	(55,1,'asdfsadf2','asdfas','','2016-02-20 02:32:14',''),
	(56,1,'dafsdf3','sadf','aa','2016-02-20 02:34:32',NULL),
	(57,1,'asdfasdf','aaaaa1',NULL,'2016-02-26 18:58:13',NULL),
	(58,1,'adfadsf','afdasfasfasd','fs','2016-04-04 06:46:05',NULL),
	(59,1,'asfdafasf','sadfa','asdfas','2016-04-04 06:46:22',NULL),
	(60,1,'asdfsfs','d',NULL,'2016-04-04 06:46:41',NULL);
...
VALUES
	(1,'datarule_symbol','=','=','2016-03-01 23:42:05'),
	(2,'datarule_symbol','>','>','2016-03-01 23:42:21'),
	(3,'datarule_symbol','<','<','2016-03-01 23:42:28'),
	(4,'datarule_symbol','>=','>=','2016-03-01 23:42:37'),
	(5,'datarule_symbol','<=','<=','2016-03-01 23:42:45'),
	(6,'db_source','zcurd','默认','2016-03-24 00:53:00'),
	(7,'db_source','bus1','业务1','2016-03-24 00:51:11');
...
VALUES
	...
	(2,'客户管理','/zcurd/133/listPage',1,'icon-search',1,'2016-01-08 08:36:59'),
	...
	(22,'客户管理','/zcurd/133/listPage',3,NULL,2,'2016-02-25 16:45:10'),
	(23,'字典管理','/zcurd/154/listPage',5,NULL,5,'2016-03-02 00:44:07');
...
VALUES
	(1,4,'status','=','0','2016-02-26 18:36:41'),
	(2,4,'reg_time','<=','2016-01-01','2016-03-02 00:19:34');
...
VALUES
	(181,2,3,'2016-03-02 00:31:44'),
	(182,2,5,'2016-03-02 00:31:44'),
	(183,2,4,'2016-03-02 00:31:44'),
	(184,2,1,'2016-03-02 00:31:44'),
	(188,1,3,'2016-03-02 00:44:17'),
	(189,1,2,'2016-03-02 00:44:17'),
	(190,1,1,'2016-03-02 00:44:17');
...
VALUES
	(8,2,2,'2016-03-02 00:31:44'),
	(9,2,1,'2016-03-02 00:31:44'),
	(11,1,2,'2016-03-02 00:44:17');
...
VALUES
	(407,2,2,'2016-03-02 00:31:44'),
	(408,2,4,'2016-03-02 00:31:44'),
	(409,2,6,'2016-03-02 00:31:44'),
	(414,1,18,'2016-03-02 00:44:17'),
	(415,1,6,'2016-03-02 00:44:17'),
	(416,1,12,'2016-03-02 00:44:17'),
	(417,1,21,'2016-03-02 00:44:17'),
	(418,1,23,'2016-03-02 00:44:17');
...
VALUES
	(1,'admin','123456','2','2016-01-08 16:33:05'),
	(2,'test','123456','2','2016-01-08 16:35:12'),
	(6,'zhong','123456','1,2','2016-02-21 02:19:47');
...
VALUES
	...
	(185,130,'info','备注',120,'text','easyui-textbox',0,1,1,0,0,0,'',7,1,'2016-01-08 16:25:53');
...
VALUES
	(130,'demo_users','游戏用户','id',1,1,'600x400','zcurd','2016-01-08 16:25:53'),
	(131,'sys_user','用户管理','id',1,1,'400x300','zcurd','2016-01-08 16:31:45'),
	(133,'customer','客户管理','cid',1,1,'900x600','zcurd','2016-01-08 17:53:35'),
	(134,'riskgrade','评级等级管理','id',1,2,'800x500','zcurd','2016-01-11 11:52:59'),
	(135,'riskgradedetail','评级等级管理详情','id',1,1,'600x400','zcurd','2016-01-11 11:53:07'),
	(136,'sys_menu_btn','菜单按钮','id',1,1,'600x400','zcurd','2016-01-11 14:53:02'),
	(137,'zcurd_head_btn','表单按钮','id',1,1,'600x400','zcurd','2016-01-12 16:58:48'),
	(138,'zcurd_head_js','表单扩展js','id',1,1,'600x400','zcurd','2016-01-13 10:35:01'),
	(144,'blog','blog','id',1,1,'600x400','zcurd','2016-01-23 01:19:21'),
	(145,'dynamic_table','dynamic_table','id',1,1,'600x400','zcurd','2016-01-23 01:19:27'),
	(147,'sys_menu','菜单','id',1,1,'600x400','zcurd','2016-01-30 11:30:26'),
	(148,'sys_role','角色管理','id',1,1,'600x400','zcurd','2016-02-12 20:58:39'),
	(149,'sys_role_btn','sys_role_btn','id',1,1,'600x400','zcurd','2016-02-15 11:35:39'),
	(150,'sys_menu_btn','菜单按钮（权限编辑）','id',1,1,'600x400','zcurd','2016-02-15 11:35:56'),
	(151,'sys_role_menu','角色菜单','id',1,1,'600x400','zcurd','2016-02-15 15:08:47'),
	(152,'sys_menu_datarule','菜单数据规则（权限编辑）','id',1,1,'400x300','zcurd','2016-02-26 18:55:58'),
	(153,'sys_role_datarule','角色数据规则','id',1,1,'600x400','zcurd','2016-02-28 22:00:03'),
	(154,'sys_dict','数据字典','id',1,1,'400x300','zcurd','2016-03-01 23:39:14'),
	(155,'tb_proc_log','存储过程运行日志','id',1,1,'600x400','zcurd','2016-03-13 16:10:43'),
	(156,'dev_gl_airpurifier_config_history','广垒空气清新机配置历史记录','id',1,1,'600x400','bus1','2016-03-16 09:40:26'),
	(157,'tb_airpurifier_active_day','设备活跃信息','id',1,1,'600x400','bus1','2016-03-16 09:43:54'),
	(158,'demo_users','游戏用户','id',1,1,'600x400','zcurd','2016-03-16 20:13:07'),
	(159,'tb_airpurifier_func_day_city','空气净化器功能使用日数据-城市','id',1,1,'600x400','bus1','2016-03-16 20:14:41');
