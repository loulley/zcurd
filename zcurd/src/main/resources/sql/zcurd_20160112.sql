...
CREATE TABLE IF NOT EXISTS `zcurd_field` (
  ...
  `create_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=475 DEFAULT CHARSET=utf8 COMMENT='在线表单字段';

-- 正在导出表  zcurd.zcurd_field 的数据：~165 rows (大约)
...
INSERT INTO `zcurd_field` (`id`, `head_id`, `field_name`, `column_name`, `column_length`, `data_type`, `is_show_list`, `is_allow_add`, `is_allow_update`, `dict_sql`, `is_search`, `order_num`, `search_type`, `create_time`) VALUES
	...
	(453, 135, 'id', 'id', 120, 'int', 1, 1, 1, '', 0, 0, 1, '2016-01-11 11:53:07'),
	(454, 135, 'riskgradeid', '等级属性id', 120, 'int', 1, 1, 1, 'select a.id, a.name from riskgrade a', 1, 0, 1, '2016-01-11 11:53:07'),
	(455, 135, 'level', '等级', 120, 'varchar', 1, 1, 1, '', 0, 0, 1, '2016-01-11 11:53:07'),
	(456, 135, 'comment', '含义', 120, 'varchar', 1, 1, 1, '', 0, 0, 1, '2016-01-11 11:53:07'),
	(457, 135, 'startrange', '分值范围开始', 120, 'int', 1, 1, 1, '', 0, 0, 1, '2016-01-11 11:53:07'),
	(458, 135, 'endrange', '分值范围结束', 120, 'int', 1, 1, 1, '', 0, 0, 1, '2016-01-11 11:53:07'),
	(459, 135, 'createtime', '创建时间', 120, 'timestamp', 1, 0, 0, '', 0, 0, 1, '2016-01-11 11:53:07'),
	...
	(469, 137, 'head_id', '所属表单', 120, 'int', 1, 1, 1, 'select id, form_name from zcurd_head', 1, 0, 1, '2016-01-12 16:58:48'),
	(470, 137, 'btn_name', '按钮名称', 120, 'varchar', 1, 1, 1, '', 0, 0, 1, '2016-01-12 16:58:48'),
	(471, 137, 'location', '按钮位置', 120, 'int', 1, 1, 1, '', 0, 0, 1, '2016-01-12 16:58:48'),
	(472, 137, 'action', '行为', 120, 'int', 1, 1, 1, '', 0, 0, 1, '2016-01-12 16:58:48'),
	(473, 137, 'func_content', '方法内容', 120, 'text', 1, 1, 1, '', 0, 0, 1, '2016-01-12 16:58:48'),
	(474, 137, 'create_time', '创建时间', 120, 'timestamp', 1, 0, 0, '', 0, 0, 1, '2016-01-12 16:58:48');
...
CREATE TABLE IF NOT EXISTS `zcurd_head` (
  ...
  `create_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=138 DEFAULT CHARSET=utf8 COMMENT='在线表单';

-- 正在导出表  zcurd.zcurd_head 的数据：~7 rows (大约)
...
INSERT INTO `zcurd_head` (`id`, `table_name`, `form_name`, `id_field`, `is_auto`, `form_type`, `dialog_size`, `create_time`) VALUES
	...
	(135, 'riskgradedetail', '评级等级管理详情', 'id', 1, 1, '800x500', '2016-01-11 11:53:07'),
	(136, 'sys_menu_btn', '菜单按钮', 'id', 1, 1, '600x400', '2016-01-11 14:53:02'),
	(137, 'zcurd_head_btn', '表单按钮', 'id', 1, 1, '800x500', '2016-01-12 16:58:48');
...
CREATE TABLE IF NOT EXISTS `zcurd_head_btn` (
  ...
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='表单按钮';
