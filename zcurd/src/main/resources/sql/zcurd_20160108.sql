...
-- 正在导出表  zcurd.customer 的数据：132 rows
...
CREATE TABLE IF NOT EXISTS `demo_users` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=55 DEFAULT CHARSET=utf8 COMMENT='游戏用户';

-- 正在导出表  zcurd.demo_users 的数据：~42 rows (大约)
...
-- 正在导出表  zcurd.sys_menu 的数据：~8 rows (大约)
...
CREATE TABLE IF NOT EXISTS `zcurd_field` (
  ...
  `create_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=594 DEFAULT CHARSET=utf8 COMMENT='在线表单字段';

-- 正在导出表  zcurd.zcurd_field 的数据：~144 rows (大约)
...
INSERT INTO `zcurd_field` (`id`, `head_id`, `field_name`, `column_name`, `column_length`, `data_type`, `is_show_list`, `dict_sql`, `order_num`, `is_search`, `search_type`, `create_time`) VALUES
	(179, 130, 'id', 'id', 120, 'int', 1, '', 1, 0, 1, '2016-01-08 16:25:53'),
	(180, 130, 'status', '状态', 120, 'int', 1, 'select 0, \'无效\' union all select 1, \'有效\'', 3, 1, 1, '2016-01-08 16:25:53'),
	(181, 130, 'login_id', '登录账户', 120, 'varchar', 1, '', 2, 1, 1, '2016-01-08 16:25:53'),
	(182, 130, 'login_pwd', '录登密码', 120, 'varchar', 1, '', 4, 0, 1, '2016-01-08 16:25:53'),
	(183, 130, 'nickname', '昵称', 120, 'varchar', 1, '', 5, 0, 1, '2016-01-08 16:25:53'),
	(184, 130, 'reg_time', '注册时间', 120, 'timestamp', 1, '', 6, 1, 2, '2016-01-08 16:25:53'),
	(185, 130, 'info', '备注', 120, 'varchar', 1, '', 7, 0, 1, '2016-01-08 16:25:53'),
	(186, 131, 'id', 'id', 120, 'int', 1, '', 0, 0, 1, '2016-01-08 16:31:45'),
	(187, 131, 'user_name', '用户名', 120, 'varchar', 1, '', 0, 1, 1, '2016-01-08 16:31:45'),
	(188, 131, 'password', '密码', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 16:31:45'),
	(189, 131, 'create_time', '创建时间', 120, 'timestamp', 1, '', 0, 1, 2, '2016-01-08 16:31:45'),
	(316, 133, 'cid', '主键客户信息表', 120, 'int', 1, '', 0, 0, 1, '2016-01-08 17:53:35'),
	(317, 133, 'source', '客户来源', 120, 'int', 1, '', 0, 0, 1, '2016-01-08 17:53:35'),
	(318, 133, 'parentid', '主借人id', 120, 'int', 1, '', 0, 0, 1, '2016-01-08 17:53:35'),
	(319, 133, 'name', '客户姓名', 120, 'varchar', 1, '', 0, 1, 1, '2016-01-08 17:53:35'),
	(320, 133, 'idcard', '客户身份证', 120, 'varchar', 1, '', 0, 1, 1, '2016-01-08 17:53:35'),
	(321, 133, 'mobile', '客户手机号码', 120, 'varchar', 1, '', 0, 1, 1, '2016-01-08 17:53:35'),
	(322, 133, 'cityid', '城市id', 120, 'int', 1, '', 0, 0, 1, '2016-01-08 17:53:35'),
	(323, 133, 'cityname', '城市名', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:35'),
	(324, 133, 'pid', '项目id', 120, 'int', 1, '', 0, 0, 1, '2016-01-08 17:53:35'),
	(325, 133, 'pname', '项目名', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:35'),
	(326, 133, 'type', '客户类型', 120, 'int', 1, '', 0, 0, 1, '2016-01-08 17:53:35'),
	(327, 133, 'status', '状态', 120, 'int', 1, '', 0, 0, 1, '2016-01-08 17:53:35'),
	(328, 133, 'mid', '使用模型', 120, 'int', 1, '', 0, 0, 1, '2016-01-08 17:53:35'),
	(329, 133, 'score', '按模型计算得分', 120, 'int', 1, '', 0, 0, 1, '2016-01-08 17:53:35'),
	(330, 133, 'tempcontent', '修改数据', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:36'),
	(331, 133, 'ordercode', '订单id', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:36'),
	(332, 133, 'price', '贷款金额', 120, 'int', 1, '', 0, 0, 1, '2016-01-08 17:53:36'),
	(333, 133, 'stime', '贷款开始时间', 120, 'date', 1, '', 0, 0, 1, '2016-01-08 17:53:36'),
	(334, 133, 'etime', '贷款结束时间', 120, 'date', 1, '', 0, 0, 1, '2016-01-08 17:53:36'),
	(335, 133, 'sex', '客户性别', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:36'),
	(336, 133, 'birthday', '出生年月', 120, 'date', 1, '', 0, 0, 1, '2016-01-08 17:53:36'),
	(337, 133, 'natiomality', '国籍', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:36'),
	(338, 133, 'nation', '民族', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:36'),
	(339, 133, 'pidtype', '证件类型', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:36'),
	(340, 133, 'pidvaildity', '证件有效期', 120, 'date', 1, '', 0, 0, 1, '2016-01-08 17:53:36'),
	(341, 133, 'pidunit', '发证机关', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:36'),
	(342, 133, 'higdegree', '最高学位', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:36'),
	(343, 133, 'health', '健康状况', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:36'),
	(344, 133, 'domloction', '户籍所在地', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:36'),
	(345, 133, 'salaryway', '工资发放形式', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:36'),
	(346, 133, 'familycount', '家庭人口数量', 120, 'int', 1, '', 0, 0, 1, '2016-01-08 17:53:36'),
	(347, 133, 'buyhouseamount', '购房金额', 120, 'int', 1, '', 0, 0, 1, '2016-01-08 17:53:36'),
	(348, 133, 'fristpayratio', '首付比例', 120, 'int', 1, '', 0, 0, 1, '2016-01-08 17:53:36'),
	(349, 133, 'loanproduct', '贷款产品', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:36'),
	(350, 133, 'applyamount', '申请金额', 120, 'double', 1, '', 0, 0, 1, '2016-01-08 17:53:36'),
	(351, 133, 'homestatus', '置业状况', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:36'),
	(352, 133, 'marriagestatus', '婚姻状态', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:36'),
	(353, 133, 'familyaddress', '家庭地址', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:36'),
	(354, 133, 'job', '职业', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:36'),
	(355, 133, 'gunitname', '单位名称-工薪', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:36'),
	(356, 133, 'gunitnature', '单位性质-工薪', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:36'),
	(357, 133, 'gjoblevel', '工作级别-工薪', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:36'),
	(358, 133, 'gmonincome', '月收入-工薪', 120, 'int', 1, '', 0, 0, 1, '2016-01-08 17:53:36'),
	(359, 133, 'gworklife', '工作年限-工薪', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:36'),
	(360, 133, 'gsalaryway', '工作发放形式-工薪', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:36'),
	(361, 133, 'zcompanyname', '企业名-自雇', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:36'),
	(362, 133, 'zindustrytype', '行业类型-自雇', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:36'),
	(363, 133, 'zmonincome', '月收入—自雇', 120, 'int', 1, '', 0, 0, 1, '2016-01-08 17:53:36'),
	(364, 133, 'zyearbus', '年营业额-自雇', 120, 'int', 1, '', 0, 0, 1, '2016-01-08 17:53:36'),
	(365, 133, 'zenterpfund', '企业资产-自雇', 120, 'int', 1, '', 0, 0, 1, '2016-01-08 17:53:36'),
	(366, 133, 'zenterploan', '企业借款-自雇', 120, 'int', 1, '', 0, 0, 1, '2016-01-08 17:53:36'),
	(367, 133, 'zmanageplace', '经营场所-自雇', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:36'),
	(368, 133, 'zsharesratio', '占股比例-自雇', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:36'),
	(369, 133, 'age', '年龄', 120, 'int', 1, '', 0, 0, 1, '2016-01-08 17:53:37'),
	(370, 133, 'bankaccount', '用户银行账户', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:37'),
	(371, 133, 'creditlimit', '信用卡最高额度', 120, 'int', 1, '', 0, 0, 1, '2016-01-08 17:53:37'),
	(372, 133, 'creditconsume', '信用卡已消费', 120, 'int', 1, '', 0, 0, 1, '2016-01-08 17:53:37'),
	(373, 133, 'otherloan', '其他贷款', 120, 'int', 1, '', 0, 0, 1, '2016-01-08 17:53:37'),
	(374, 133, 'contname', '紧急联系人姓名', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:37'),
	(375, 133, 'contage', '紧急联系人年龄', 120, 'int', 1, '', 0, 0, 1, '2016-01-08 17:53:37'),
	(376, 133, 'contsex', '紧急联系人性别', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:37'),
	(377, 133, 'contrelation', '紧急联系人关系', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:37'),
	(378, 133, 'contloan', '经济联系人是否知晓贷款', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:37'),
	(379, 133, 'contmobile', '紧急联系人电话', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:37'),
	(380, 133, 'contphone', '紧急联系人住宅电话', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:37'),
	(381, 133, 'contaddress', '紧急联系人地址', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:37'),
	(382, 133, 'contunitname', '紧急联系人单位名称', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:37'),
	(383, 133, 'contunitphone', '紧急联系人单位电话', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:37'),
	(384, 133, 'contunitaddress', '紧急联系人单位地址', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:37'),
	(385, 133, 'contworkdep', '紧急联系人工作部门', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:37'),
	(386, 133, 'contposition', '紧急联系人工作职位', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:37'),
	(387, 133, 'adid', 'adid', 120, 'int', 1, '', 0, 0, 1, '2016-01-08 17:53:37'),
	(388, 133, 'ctime', 'ctime', 120, 'datetime', 1, '', 0, 0, 1, '2016-01-08 17:53:37'),
	(389, 133, 'aname', 'aname', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:37'),
	(390, 133, 'creditNumber', 'creditNumber', 120, 'int', 1, '', 0, 0, 1, '2016-01-08 17:53:37'),
	(391, 133, 'zenterpborrow', 'zenterpborrow', 120, 'double', 1, '', 0, 0, 1, '2016-01-08 17:53:37'),
	(392, 133, 'creditLoanMoney', 'creditLoanMoney', 120, 'double', 1, '', 0, 0, 1, '2016-01-08 17:53:37'),
	(393, 133, 'relations', 'relations', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:37'),
	(394, 133, 'xsid', 'xsid', 120, 'int', 1, '', 0, 0, 1, '2016-01-08 17:53:37'),
	(395, 133, 'xsname', 'xsname', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:37'),
	(396, 133, 'gunitaddress', 'gunitaddress', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:37'),
	(397, 133, 'zcompanyaddress', 'zcompanyaddress', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:37'),
	(398, 133, 'loantimelimit', 'loantimelimit', 120, 'int', 1, '', 0, 0, 1, '2016-01-08 17:53:37'),
	(399, 133, 'fund', 'fund', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:37'),
	(400, 133, 'fundname', 'fundname', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:37'),
	(401, 133, 'examindate', '报审时间', 120, 'date', 1, '', 0, 0, 1, '2016-01-08 17:53:37'),
	(402, 133, 'fkid', 'fkid', 120, 'int', 1, '', 0, 0, 1, '2016-01-08 17:53:37'),
	(403, 133, 'personPath', 'personPath', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:37'),
	(404, 133, 'period', 'period', 120, 'int', 1, '', 0, 0, 1, '2016-01-08 17:53:37'),
	(405, 133, 'repay', 'repay', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:37'),
	(406, 133, 'signstatus', '签约状态', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:37'),
	(407, 133, 'signtime', '签约时间', 120, 'date', 1, '', 0, 0, 1, '2016-01-08 17:53:37'),
	(408, 133, 'loanstatus', '放款状态', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:37'),
	(409, 133, 'loantime', '放款时间', 120, 'date', 1, '', 0, 0, 1, '2016-01-08 17:53:37'),
	(410, 133, 'recviway', '还款方式1 pos机器 2现金  3转账  4其他', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:37'),
	(411, 133, 'posamount', '放款金额', 120, 'int', 1, '', 0, 0, 1, '2016-01-08 17:53:37'),
	(412, 133, 'postime', 'pos刷卡时间', 120, 'date', 1, '', 0, 0, 1, '2016-01-08 17:53:38'),
	(413, 133, 'cashamount', '现金金额', 120, 'int', 1, '', 0, 0, 1, '2016-01-08 17:53:38'),
	(414, 133, 'cashtime', '现金付款时间', 120, 'date', 1, '', 0, 0, 1, '2016-01-08 17:53:38'),
	(415, 133, 'transferamount', '转账金额', 120, 'int', 1, '', 0, 0, 1, '2016-01-08 17:53:38'),
	(416, 133, 'transfertime', '转账时间', 120, 'date', 1, '', 0, 0, 1, '2016-01-08 17:53:38'),
	(417, 133, 'otheramount', '加他付款方式', 120, 'int', 1, '', 0, 0, 1, '2016-01-08 17:53:38'),
	(418, 133, 'othertime', 'othertime', 120, 'date', 1, '', 0, 0, 1, '2016-01-08 17:53:38'),
	(419, 133, 'urgentlevel', '紧急程度', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:38'),
	(420, 133, 'applyloandate', '申请放款时间', 120, 'date', 1, '', 0, 0, 1, '2016-01-08 17:53:38'),
	(421, 133, 'accountbranch', '开户支行', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:38'),
	(422, 133, 'loanbankaccount', '还款银行卡号', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:38'),
	(423, 133, 'houseConsultant', '职业顾问', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:38'),
	(424, 133, 'consultantphone', '顾问号码', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:38'),
	(425, 133, 'refundamount', '退款金额', 120, 'int', 1, '', 0, 0, 1, '2016-01-08 17:53:38'),
	(426, 133, 'refundtime', '退款时间', 120, 'date', 1, '', 0, 0, 1, '2016-01-08 17:53:38'),
	(427, 133, 'loanMoney', 'loanMoney', 120, 'double', 1, '', 0, 0, 1, '2016-01-08 17:53:38'),
	(428, 133, 'creditLevel', '信用卡等级', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:38'),
	(429, 133, 'buyhouseaddress', '客户新买房新地址', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:38'),
	(430, 133, 'gjrelation', '共借人关系', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:38'),
	(431, 133, 'approvalopinion', '审批意见', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:38'),
	(432, 133, 'archstatus', '资料归档情况', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:38'),
	(433, 133, 'archtime', '资料归档时间', 120, 'date', 1, '', 0, 0, 1, '2016-01-08 17:53:38'),
	(434, 133, 'archremark', '资料归档备注', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:38'),
	(435, 133, 'mortgagestatus', '按揭情况', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:38'),
	(436, 133, 'mortgageremark', '按揭备注', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:38'),
	(437, 133, 'repaystatus', '还款情况', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:38'),
	(438, 133, 'overduecount', '逾期次数', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:38'),
	(439, 133, 'overfueremark', '逾期记录', 120, 'varchar', 1, '', 0, 0, 1, '2016-01-08 17:53:38'),
	(440, 133, 'cheLoanMoney', 'cheLoanMoney', 120, 'int', 1, '', 0, 0, 1, '2016-01-08 17:53:38'),
	(441, 133, 'houseLoanMoney', 'houseLoanMoney', 120, 'int', 1, '', 0, 0, 1, '2016-01-08 17:53:38'),
	(468, 141, 'cid', '主键客户信息表', 120, 'int', 1, NULL, 0, 0, 1, '2016-01-08 18:39:30'),
	(469, 141, 'source', '客户来源', 120, 'int', 1, NULL, 0, 0, 1, '2016-01-08 18:39:30'),
	(470, 141, 'parentid', '主借人id', 120, 'int', 1, NULL, 0, 0, 1, '2016-01-08 18:39:30'),
	(471, 141, 'name', '客户姓名', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:30'),
	(472, 141, 'idcard', '客户身份证', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:30'),
	(473, 141, 'mobile', '客户手机号码', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:30'),
	(474, 141, 'cityid', '城市id', 120, 'int', 1, NULL, 0, 0, 1, '2016-01-08 18:39:30'),
	(475, 141, 'cityname', '城市名', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:30'),
	(476, 141, 'pid', '项目id', 120, 'int', 1, NULL, 0, 0, 1, '2016-01-08 18:39:30'),
	(477, 141, 'pname', '项目名', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:30'),
	(478, 141, 'type', '客户类型', 120, 'int', 1, NULL, 0, 0, 1, '2016-01-08 18:39:30'),
	(479, 141, 'status', '状态', 120, 'int', 1, NULL, 0, 0, 1, '2016-01-08 18:39:30'),
	(480, 141, 'mid', '使用模型', 120, 'int', 1, NULL, 0, 0, 1, '2016-01-08 18:39:30'),
	(481, 141, 'score', '按模型计算得分', 120, 'int', 1, NULL, 0, 0, 1, '2016-01-08 18:39:30'),
	(482, 141, 'tempcontent', '修改数据', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:30'),
	(483, 141, 'ordercode', '订单id', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:31'),
	(484, 141, 'price', '贷款金额', 120, 'int', 1, NULL, 0, 0, 1, '2016-01-08 18:39:31'),
	(485, 141, 'stime', '贷款开始时间', 120, 'date', 1, NULL, 0, 0, 1, '2016-01-08 18:39:31'),
	(486, 141, 'etime', '贷款结束时间', 120, 'date', 1, NULL, 0, 0, 1, '2016-01-08 18:39:31'),
	(487, 141, 'sex', '客户性别', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:31'),
	(488, 141, 'birthday', '出生年月', 120, 'date', 1, NULL, 0, 0, 1, '2016-01-08 18:39:31'),
	(489, 141, 'natiomality', '国籍', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:31'),
	(490, 141, 'nation', '民族', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:31'),
	(491, 141, 'pidtype', '证件类型', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:31'),
	(492, 141, 'pidvaildity', '证件有效期', 120, 'date', 1, NULL, 0, 0, 1, '2016-01-08 18:39:31'),
	(493, 141, 'pidunit', '发证机关', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:31'),
	(494, 141, 'higdegree', '最高学位', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:31'),
	(495, 141, 'health', '健康状况', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:31'),
	(496, 141, 'domloction', '户籍所在地', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:31'),
	(497, 141, 'salaryway', '工资发放形式', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:31'),
	(498, 141, 'familycount', '家庭人口数量', 120, 'int', 1, NULL, 0, 0, 1, '2016-01-08 18:39:31'),
	(499, 141, 'buyhouseamount', '购房金额', 120, 'int', 1, NULL, 0, 0, 1, '2016-01-08 18:39:31'),
	(500, 141, 'fristpayratio', '首付比例', 120, 'int', 1, NULL, 0, 0, 1, '2016-01-08 18:39:31'),
	(501, 141, 'loanproduct', '贷款产品', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:31'),
	(502, 141, 'applyamount', '申请金额', 120, 'double', 1, NULL, 0, 0, 1, '2016-01-08 18:39:31'),
	(503, 141, 'homestatus', '置业状况', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:31'),
	(504, 141, 'marriagestatus', '婚姻状态', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:31'),
	(505, 141, 'familyaddress', '家庭地址', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:31'),
	(506, 141, 'job', '职业', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:31'),
	(507, 141, 'gunitname', '单位名称-工薪', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:31'),
	(508, 141, 'gunitnature', '单位性质-工薪', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:31'),
	(509, 141, 'gjoblevel', '工作级别-工薪', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:31'),
	(510, 141, 'gmonincome', '月收入-工薪', 120, 'int', 1, NULL, 0, 0, 1, '2016-01-08 18:39:31'),
	(511, 141, 'gworklife', '工作年限-工薪', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:31'),
	(512, 141, 'gsalaryway', '工作发放形式-工薪', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:31'),
	(513, 141, 'zcompanyname', '企业名-自雇', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:31'),
	(514, 141, 'zindustrytype', '行业类型-自雇', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:31'),
	(515, 141, 'zmonincome', '月收入—自雇', 120, 'int', 1, NULL, 0, 0, 1, '2016-01-08 18:39:31'),
	(516, 141, 'zyearbus', '年营业额-自雇', 120, 'int', 1, NULL, 0, 0, 1, '2016-01-08 18:39:31'),
	(517, 141, 'zenterpfund', '企业资产-自雇', 120, 'int', 1, NULL, 0, 0, 1, '2016-01-08 18:39:31'),
	(518, 141, 'zenterploan', '企业借款-自雇', 120, 'int', 1, NULL, 0, 0, 1, '2016-01-08 18:39:31'),
	(519, 141, 'zmanageplace', '经营场所-自雇', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:31'),
	(520, 141, 'zsharesratio', '占股比例-自雇', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:32'),
	(521, 141, 'age', '年龄', 120, 'int', 1, NULL, 0, 0, 1, '2016-01-08 18:39:32'),
	(522, 141, 'bankaccount', '用户银行账户', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:32'),
	(523, 141, 'creditlimit', '信用卡最高额度', 120, 'int', 1, NULL, 0, 0, 1, '2016-01-08 18:39:32'),
	(524, 141, 'creditconsume', '信用卡已消费', 120, 'int', 1, NULL, 0, 0, 1, '2016-01-08 18:39:32'),
	(525, 141, 'otherloan', '其他贷款', 120, 'int', 1, NULL, 0, 0, 1, '2016-01-08 18:39:32'),
	(526, 141, 'contname', '紧急联系人姓名', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:32'),
	(527, 141, 'contage', '紧急联系人年龄', 120, 'int', 1, NULL, 0, 0, 1, '2016-01-08 18:39:32'),
	(528, 141, 'contsex', '紧急联系人性别', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:32'),
	(529, 141, 'contrelation', '紧急联系人关系', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:32'),
	(530, 141, 'contloan', '经济联系人是否知晓贷款', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:32'),
	(531, 141, 'contmobile', '紧急联系人电话', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:32'),
	(532, 141, 'contphone', '紧急联系人住宅电话', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:32'),
	(533, 141, 'contaddress', '紧急联系人地址', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:32'),
	(534, 141, 'contunitname', '紧急联系人单位名称', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:32'),
	(535, 141, 'contunitphone', '紧急联系人单位电话', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:32'),
	(536, 141, 'contunitaddress', '紧急联系人单位地址', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:32'),
	(537, 141, 'contworkdep', '紧急联系人工作部门', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:32'),
	(538, 141, 'contposition', '紧急联系人工作职位', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:32'),
	(539, 141, 'adid', 'adid', 120, 'int', 1, NULL, 0, 0, 1, '2016-01-08 18:39:32'),
	(540, 141, 'ctime', 'ctime', 120, 'datetime', 1, NULL, 0, 0, 1, '2016-01-08 18:39:32'),
	(541, 141, 'aname', 'aname', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:32'),
	(542, 141, 'creditNumber', 'creditNumber', 120, 'int', 1, NULL, 0, 0, 1, '2016-01-08 18:39:32'),
	(543, 141, 'zenterpborrow', 'zenterpborrow', 120, 'double', 1, NULL, 0, 0, 1, '2016-01-08 18:39:32'),
	(544, 141, 'creditLoanMoney', 'creditLoanMoney', 120, 'double', 1, NULL, 0, 0, 1, '2016-01-08 18:39:32'),
	(545, 141, 'relations', 'relations', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:32'),
	(546, 141, 'xsid', 'xsid', 120, 'int', 1, NULL, 0, 0, 1, '2016-01-08 18:39:32'),
	(547, 141, 'xsname', 'xsname', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:32'),
	(548, 141, 'gunitaddress', 'gunitaddress', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:32'),
	(549, 141, 'zcompanyaddress', 'zcompanyaddress', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:32'),
	(550, 141, 'loantimelimit', 'loantimelimit', 120, 'int', 1, NULL, 0, 0, 1, '2016-01-08 18:39:32'),
	(551, 141, 'fund', 'fund', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:32'),
	(552, 141, 'fundname', 'fundname', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:32'),
	(553, 141, 'examindate', '报审时间', 120, 'date', 1, NULL, 0, 0, 1, '2016-01-08 18:39:32'),
	(554, 141, 'fkid', 'fkid', 120, 'int', 1, NULL, 0, 0, 1, '2016-01-08 18:39:32'),
	(555, 141, 'personPath', 'personPath', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:32'),
	(556, 141, 'period', 'period', 120, 'int', 1, NULL, 0, 0, 1, '2016-01-08 18:39:32'),
	(557, 141, 'repay', 'repay', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:32'),
	(558, 141, 'signstatus', '签约状态', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:33'),
	(559, 141, 'signtime', '签约时间', 120, 'date', 1, NULL, 0, 0, 1, '2016-01-08 18:39:33'),
	(560, 141, 'loanstatus', '放款状态', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:33'),
	(561, 141, 'loantime', '放款时间', 120, 'date', 1, NULL, 0, 0, 1, '2016-01-08 18:39:33'),
	(562, 141, 'recviway', '还款方式1 pos机器 2现金  3转账  4其他', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:33'),
	(563, 141, 'posamount', '放款金额', 120, 'int', 1, NULL, 0, 0, 1, '2016-01-08 18:39:33'),
	(564, 141, 'postime', 'pos刷卡时间', 120, 'date', 1, NULL, 0, 0, 1, '2016-01-08 18:39:33'),
	(565, 141, 'cashamount', '现金金额', 120, 'int', 1, NULL, 0, 0, 1, '2016-01-08 18:39:33'),
	(566, 141, 'cashtime', '现金付款时间', 120, 'date', 1, NULL, 0, 0, 1, '2016-01-08 18:39:33'),
	(567, 141, 'transferamount', '转账金额', 120, 'int', 1, NULL, 0, 0, 1, '2016-01-08 18:39:33'),
	(568, 141, 'transfertime', '转账时间', 120, 'date', 1, NULL, 0, 0, 1, '2016-01-08 18:39:33'),
	(569, 141, 'otheramount', '加他付款方式', 120, 'int', 1, NULL, 0, 0, 1, '2016-01-08 18:39:33'),
	(570, 141, 'othertime', 'othertime', 120, 'date', 1, NULL, 0, 0, 1, '2016-01-08 18:39:33'),
	(571, 141, 'urgentlevel', '紧急程度', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:33'),
	(572, 141, 'applyloandate', '申请放款时间', 120, 'date', 1, NULL, 0, 0, 1, '2016-01-08 18:39:33'),
	(573, 141, 'accountbranch', '开户支行', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:33'),
	(574, 141, 'loanbankaccount', '还款银行卡号', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:33'),
	(575, 141, 'houseConsultant', '职业顾问', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:33'),
	(576, 141, 'consultantphone', '顾问号码', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:33'),
	(577, 141, 'refundamount', '退款金额', 120, 'int', 1, NULL, 0, 0, 1, '2016-01-08 18:39:33'),
	(578, 141, 'refundtime', '退款时间', 120, 'date', 1, NULL, 0, 0, 1, '2016-01-08 18:39:33'),
	(579, 141, 'loanMoney', 'loanMoney', 120, 'double', 1, NULL, 0, 0, 1, '2016-01-08 18:39:33'),
	(580, 141, 'creditLevel', '信用卡等级', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:33'),
	(581, 141, 'buyhouseaddress', '客户新买房新地址', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:33'),
	(582, 141, 'gjrelation', '共借人关系', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:33'),
	(583, 141, 'approvalopinion', '审批意见', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:33'),
	(584, 141, 'archstatus', '资料归档情况', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:33'),
	(585, 141, 'archtime', '资料归档时间', 120, 'date', 1, NULL, 0, 0, 1, '2016-01-08 18:39:33'),
	(586, 141, 'archremark', '资料归档备注', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:33'),
	(587, 141, 'mortgagestatus', '按揭情况', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:33'),
	(588, 141, 'mortgageremark', '按揭备注', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:33'),
	(589, 141, 'repaystatus', '还款情况', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:33'),
	(590, 141, 'overduecount', '逾期次数', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:33'),
	(591, 141, 'overfueremark', '逾期记录', 120, 'varchar', 1, NULL, 0, 0, 1, '2016-01-08 18:39:33'),
	(592, 141, 'cheLoanMoney', 'cheLoanMoney', 120, 'int', 1, NULL, 0, 0, 1, '2016-01-08 18:39:33'),
	(593, 141, 'houseLoanMoney', 'houseLoanMoney', 120, 'int', 1, NULL, 0, 0, 1, '2016-01-08 18:39:33');
...
CREATE TABLE IF NOT EXISTS `zcurd_head` (
  ...
  `datagrid_option` varchar(500) DEFAULT NULL COMMENT '表单参数',
  `create_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=142 DEFAULT CHARSET=utf8 COMMENT='在线表单';

-- 正在导出表  zcurd.zcurd_head 的数据：~4 rows (大约)
/*!40000 ALTER TABLE `zcurd_head` DISABLE KEYS */;
INSERT INTO `zcurd_head` (`id`, `table_name`, `form_name`, `id_field`, `is_auto`, `datagrid_option`, `create_time`) VALUES
	(130, 'demo_users', '游戏用户', 'id', 1, NULL, '2016-01-08 16:25:53'),
	(131, 'sys_user', '用户管理', 'id', 1, NULL, '2016-01-08 16:31:45'),
	(133, 'customer', '客户管理', 'cid', 1, NULL, '2016-01-08 17:53:35'),
	(141, 'customer', '客户管理', 'cid', 1, NULL, '2016-01-08 18:39:30');
