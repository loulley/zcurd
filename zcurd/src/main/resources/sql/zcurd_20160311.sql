...
# Database: zcurd
# Generation Time: 2016-03-10 17:14:50 +0000
# ************************************************************
...
VALUES
	...
	(542,150,'menu_id','所属菜单',100,'int','easyui-numberspinner',1,1,1,1,1,1,'select id, menu_name from sys_menu',0,1,'2016-02-15 11:35:56'),
	(543,150,'btn_name','按钮名称',100,'varchar','easyui-textbox',1,1,1,1,0,1,'',0,1,'2016-02-15 11:35:56'),
	(544,150,'class_name','页面class名称',100,'varchar','easyui-textbox',1,1,1,1,0,1,'',0,1,'2016-02-15 11:35:56'),
...
VALUES
	...
	(152,'sys_menu_datarule','菜单数据规则（权限编辑）','id',1,1,'400x300','2016-02-26 18:55:58'),
	(153,'sys_role_datarule','角色数据规则','id',1,1,'600x400','2016-02-28 22:00:03'),
	(154,'sys_dict','数据字典','id',1,1,'400x300','2016-03-01 23:39:14');
